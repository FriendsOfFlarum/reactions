    ...
    if (post.discussion().canSeeReactions()) {
      items.add('viewReactions', [m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_5___default.a, {
        ...
        onclick: function onclick() {
          flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(new _components_ReactionsModal__WEBPACK_IMPORTED_MODULE_6__["default"]({
            post: post
          }));
        }
...
/* harmony import */ var _common_util_emoji__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/util/emoji */ "./src/common/util/emoji.js");
...
var PostReactAction = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PostReactAction, _Component);
  ...
  _proto.getReactions = function getReactions() {
    ...
    app.forum.reactions().forEach(function (reaction) {
      ...
      if (reaction.type() === 'emoji') {
        var url = _this.names[reaction.identifier()];
  ...
  _proto.init = function init() {
    ...
    this.reaction = app.session.user && reactions.filter(function (reaction) {
      return reaction.user_id() == app.session.user.data.id;
    })[0];
    this.reacted = {};
    this.names = {};
    app.forum.reactions().forEach(function (reaction) {
      var e = Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_6__["default"])(reaction.identifier());
      if (!e) return;
      _this2.names[reaction.identifier()] = e.url;
      _this2.reacted[reaction.identifier()] = [];
    });
    Object.keys(this.names).forEach(function (reaction) {
      _this2.reacted[reaction] = reactions.filter(function (e) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "Reactions"
    }, this.reactButton(), Object.keys(this.reacted).map(function (identifier) {
      var count = _this3.reacted[identifier].length;
      ...
      var icon = reaction.type() === 'emoji' ? m("img", {
        ...
        draggable: "false",
        loading: "lazy",
        src: Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_6__["default"])(reaction.identifier()).url,
      ...
      return [m("span", {
        ...
        onclick: _this3.post.user() !== app.session.user ? function (el) {
          return _this3.react(_this3.reaction ? identifier : el);
        } : '',
        "data-reaction": identifier
      }, icon, count > 1 ? count : '')];
    }), !this.reaction && this.post.user() !== app.session.user ? m("div", {
      className: "CommentPost--Reactions",
      style: this.post.number() === 1 ? '' : 'left: -28%;'
    }, m("ul", {
      className: "Reactions--Ul"
    }, flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_4___default()(this.getReactions().toArray()))) : null);
  };
  ...
  _proto.reactButton = function reactButton() {
    ...
    return m("button", {
      ...
      className: "Button-label",
      style: this.reaction ? 'display: none' : 'display:'
    }, m("svg", {
      "class": "button-react",
      width: "20px",
      height: "20px",
  ...
  _proto.react = function react(el) {
    var _this4 = this;
    ...
    this.post.save({
      ...
      var identifier = _this4.reaction && _this4.reaction.identifier();

      var reactions = _this4.post.reactions() || [];
      _this4.reaction = reactions.filter(function (r) {
      ...
      if (app.forum.data.relationships.ranks !== undefined && (app.forum.attribute('ReactionConverts')[0] === reaction || app.forum.attribute('ReactionConverts')[1] === reaction) || _this4.post.data.relationships.likes !== undefined && app.forum.attribute('ReactionConverts')[2] === reaction) {
        app.alerts.show(_this4.successAlert = new flarum_components_Alert__WEBPACK_IMPORTED_MODULE_1___default.a({
          type: 'warning',
        ...
        if (isReacted) {
          _this4.reacted[reaction].push(_this4.reaction);
        } else {
          _this4.reacted[identifier] = _this4.reacted[identifier].filter(function (r) {
...
var PostReactedNotification = /*#__PURE__*/function (_Notification) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PostReactedNotification, _Notification);
...
/* harmony import */ var _common_util_emoji__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/util/emoji */ "./src/common/util/emoji.js");
...
var ReactionsModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(ReactionsModal, _Modal);
  ...
  _proto.init = function init() {
    ...
    this.idToReaction = app.forum.reactions().filter(function (x) {
      return x.display();
    }).reduce(function (a, x) {
      var _extends2;

      return Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, a), {}, (_extends2 = {}, _extends2[Number(x.id())] = x.display(), _extends2));
    }, {});
    this.groupToPreloaded = {};
    this.groupedReactions = this.groupReactions(this.props.post.reactions());
    this.groupedReactions.forEach(function (g) {
      g.forEach(function (r) {
        app.store.find('users', r['userId']).then(function (user) {
          _this.groupToPreloaded[r['id']]['modalUsers'].push(m("li", null, m("a", {
  ...
  _proto.content = function content() {
    ...
    }, this.groupedReactions.map(function (g) {
      var preloadedGroup = _this2.groupToPreloaded[g[0]['id']];
      return m("div", {
        className: "ReactionsModal-group"
      }, m("legend", null, preloadedGroup['legend']), m("hr", {
        className: "ReactionsModal-delimiter"
      }), preloadedGroup['modalUsers']);
    })));
  };

  _proto.groupReactions = function groupReactions(reactions) {
    var _this3 = this;

    // Recreate reactions to only have useful data
    var informativeReactions = reactions.map(function (r) {
      var t = {};
      ...
      if (!(t['id'] in _this3.groupToPreloaded)) {
        _this3.groupToPreloaded[t['id']] = {
          'legend': [],
          'modalUsers': []
        };

        if (r.type() === 'emoji') {
          _this3.groupToPreloaded[t['id']]['legend'].push(m("img", {
            className: "ReactionsModal-emoji",
            src: Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_5__["default"])(r.identifier()).url
          }));
        } else if (r.type() === 'icon') {
          _this3.groupToPreloaded[t['id']]['legend'].push(m("i", {
            className: "fa fa-" + r.identifier() + " ReactionsModal-icon",
            "data-reaction": r.identifier()
          }));
        }
        /*
        ...
        */
        ...
        _this3.groupToPreloaded[t['id']]['legend'].push(m("label", {
          className: "ReactionsModal-display"
        }, _this3.groupToPreloaded[t['id']]['legend'].length === 0 ? r.identifier() : _this3.idToReaction[t['id']] || ''));
      }

      return t;
    }); // Group extensions by id, sort them by the id

    var groupedReactions = Object.values(informativeReactions.reduce(function (rv, x) {
...
/* harmony import */ var _addReactionAction__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./addReactionAction */ "./src/forum/addReactionAction.js");
/* harmony import */ var _components_PostReactedNotification__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/PostReactedNotification */ "./src/forum/components/PostReactedNotification.js");
/* harmony import */ var _common_models_Reaction__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/models/Reaction */ "./src/common/models/Reaction.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('fof/reactions', function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.models.reactions = _common_models_Reaction__WEBPACK_IMPORTED_MODULE_10__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.notificationComponents.postReacted = _components_PostReactedNotification__WEBPACK_IMPORTED_MODULE_9__["default"];
  ...
  Object(_addReactionAction__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'config', function (x, isInitialized, context) {
    var _this = this;
      ...
      flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.pusher.then(function (channels) {
        channels.main.bind('newReaction', function (data) {
          ...
          if (parseInt(_this.props.post.id()) === parseInt(data.postId)) {
            ...
            Object.keys(data.reaction).map(function (key) {
              reaction[key] = m.prop(data.reaction[key]);
            });
            reaction['identifier'] = m.prop(data.identifier);

            var newReactions = _this.props.post.reactions();

            newReactions.push(reaction);
            _this.props.post.reactions = m.prop(newReactions);
            m.redraw.strategy('all');
            m.endComputation();
          }
        });
        channels.main.bind('removedReaction', function (data) {
          var userId = parseInt(data.userId);
          ...
          if (parseInt(_this.props.post.id()) === parseInt(data.postId)) {
            ...
            var newReactions = _this.props.post.reactions().filter(function (r) {
              return !(r.user_id() == userId && r.post_id() == postId && r.identifier() == identifier);
            });
