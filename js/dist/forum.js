...
/***/ "./src/common/generated/emojis.json":
/*!******************************************!*\
  !*** ./src/common/generated/emojis.json ***!
  \******************************************/
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_es6_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(Reaction, _mixin);
...
/* harmony import */ var _babel_runtime_core_js_string_from_code_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/core-js/string/from-code-point */ "./node_modules/@babel/runtime/core-js/string/from-code-point.js");
/* harmony import */ var _babel_runtime_core_js_string_from_code_point__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_core_js_string_from_code_point__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _babel_runtime_core_js_object_values__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/core-js/object/values */ "./node_modules/@babel/runtime/core-js/object/values.js");
/* harmony import */ var _babel_runtime_core_js_object_values__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_core_js_object_values__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _generated_emojis_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../generated/emojis.json */ "./src/common/generated/emojis.json");
var _generated_emojis_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../generated/emojis.json */ "./src/common/generated/emojis.json", 1);
...
var shortnames = flatten(_babel_runtime_core_js_object_values__WEBPACK_IMPORTED_MODULE_2___default()(_generated_emojis_json__WEBPACK_IMPORTED_MODULE_3__));

var entries = _babel_runtime_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(_generated_emojis_json__WEBPACK_IMPORTED_MODULE_3__);
...
var toUnicodeEmoji = function toUnicodeEmoji(codePoint) {
  return _babel_runtime_core_js_string_from_code_point__WEBPACK_IMPORTED_MODULE_0___default.a.apply(String, codePoint.split('-').map(function (e) {
    return "0x" + e;
  }));
};
...
function Match(input) {
  var r = _generated_emojis_json__WEBPACK_IMPORTED_MODULE_3__[input],
      finalScore = -1,
      emojiName = null;
  this.input = input;
  ...
  if (r) {
    ...
    _babel_runtime_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(_generated_emojis_json__WEBPACK_IMPORTED_MODULE_3__).forEach(function (_ref2) {
      var n = _ref2[0],
          e = _ref2[1];
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'actionItems', function (items) {
    ...
    var reaction = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user && post.reactions().some(function (user) {
...
/* harmony import */ var _babel_runtime_helpers_es6_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/es6/inheritsLoose */ "./node_modules/@babel/runtime/helpers/es6/inheritsLoose.js");
...
/* harmony import */ var _common_util_emoji__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../common/util/emoji */ "./src/common/util/emoji.js");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_es6_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(PostReactAction, _Component);
  ...
  _proto.getReactions = function getReactions() {
    ...
    app.forum.reactions().forEach(function (reaction) {
      ...
      items.add(reaction.identifier(), m("button", {
  ...
  _proto.init = function init() {
    ...
    this.names = {};
    app.forum.reactions().forEach(function (reaction) {
      var e = Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_7__["default"])(reaction.identifier());
      if (!e) return;
    ...
    _babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.names).forEach(function (reaction) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "Reactions"
    }, this.reactButton(), _babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.reacted).map(function (identifier) {
      ...
      var icon = reaction.type() === 'emoji' ? m("img", {
        ...
        draggable: "false",
        src: Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_7__["default"])(reaction.identifier()).url,
  ...
  _proto.react = function react(el) {
    ...
    if (!this.post.canReact()) {
      app.alerts.show(this.successAlert = new flarum_components_Alert__WEBPACK_IMPORTED_MODULE_2___default.a({
        type: 'error',
    ...
    this.post.save({
      ...
      _this4.reaction = _this4.post.reactions().filter(function (r) {
      ...
      if (app.forum.data.relationships.ranks !== undefined && (app.forum.attribute('ReactionConverts')[0] === reaction || app.forum.attribute('ReactionConverts')[1] === reaction) || _this4.post.data.relationships.likes !== undefined && app.forum.attribute('ReactionConverts')[2] === reaction) {
        app.alerts.show(_this4.successAlert = new flarum_components_Alert__WEBPACK_IMPORTED_MODULE_2___default.a({
          type: 'warning',
...
function (_Notification) {
  Object(_babel_runtime_helpers_es6_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PostReactedNotification, _Notification);
...
/* harmony import */ var _addReactionAction__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./addReactionAction */ "./src/forum/addReactionAction.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('reflar-reactions', function () {
  ...
  Object(_addReactionAction__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_5___default.a.prototype, 'notificationTypes', function (items) {
    items.add('postReacted', {
      name: 'postReacted',
      icon: 'eye',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('reflar-reactions.forum.settings.notify_post_reacted_label')
    });
  });
});
