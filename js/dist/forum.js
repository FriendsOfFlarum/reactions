...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ReactionComponent; });
/* harmony import */ var _babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/extends.js */ "./node_modules/@babel/runtime/helpers/esm/extends.js");
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose.js */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
var ReactionComponent =
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_1__["default"])(ReactionComponent, _Component);

  function ReactionComponent() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = ReactionComponent.prototype;

  _proto.view = function view() {
    var attrs = Object(_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.props);

    var reaction = flarum_utils_extract__WEBPACK_IMPORTED_MODULE_3___default()(attrs, 'reaction');
    var className = flarum_utils_extract__WEBPACK_IMPORTED_MODULE_3___default()(attrs, 'className');
    if (!reaction) return m("span", null);
    var display = reaction.display() || reaction.identifier();
    if (!attrs.title) attrs.title = display;

    if (reaction.type() === 'emoji') {
      var _emoji = Object(_util_emoji__WEBPACK_IMPORTED_MODULE_4__["default"])(reaction.identifier()),
          url = _emoji.url;

      return m("img", Object(_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
      ...
      return m("i", Object(_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose.js */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Reaction, _mixin);
  ...
  reaction_id: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('reaction_id')
}));
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'config', function (x, isInitialized, context) {
    ...
    if (app.pusher) {
      app.pusher.then(function (channels) {
        channels.main.bind('newReaction', function (_ref) {
          var id = _ref.id,
              userId = _ref.userId,
              postId = _ref.postId,
              reactionId = _ref.reactionId;
          var reaction = app.store.getById('reactions', reactionId);
          var post = app.store.getById('posts', postId);
          ...
          if (!post.data.relationships.post_reactions) post.data.relationships.post_reactions = {
            data: []
          };
        ...
        channels.main.bind('removedReaction', function (_ref2) {
          var userId = _ref2.userId,
              postId = _ref2.postId,
              reactionId = _ref2.reactionId;
          var postReaction = app.store.all('post_reactions').filter(function (r) {
            return r.userId() == userId && r.postId() == postId && r.reactionId() == reactionId;
          })[0];
        ...
        Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(context, 'onunload', function () {
          return channels.main.unbind('newReaction');
        });
        Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(context, 'onunload', function () {
          return channels.main.unbind('removedReaction');
        });
      });
    }
  });
...
/* harmony import */ var _components_ReactionsModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/ReactionsModal */ "./src/forum/components/ReactionsModal.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'actionItems', function (items) {
    ...
    var reaction = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user && Array.isArray(post.reactions()) && post.reactions().some(function (user) {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_utils_PostControls__WEBPACK_IMPORTED_MODULE_4___default.a, 'moderationControls', function (items, post) {
    if (post.discussion().canSeeReactions() && post.reactions() && post.reactions().length) {
      items.add('viewReactions', m(flarum_components_Button__WEBPACK_IMPORTED_MODULE_5___default.a, {
        icon: "fas fa-heart",
        onclick: function onclick() {
          return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(new _components_ReactionsModal__WEBPACK_IMPORTED_MODULE_6__["default"]({
            post: post
          }));
        }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PostReactAction; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose.js */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
/* harmony import */ var _utils_groupBy__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/groupBy */ "./src/forum/utils/groupBy.js");
/* harmony import */ var _common_components_ReactionComponent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/components/ReactionComponent */ "./src/common/components/ReactionComponent.js");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__["default"])(PostReactAction, _Component);

  function PostReactAction() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = PostReactAction.prototype;
  ...
  _proto.getReactions = function getReactions() {
    var _this = this;

    var items = new flarum_utils_ItemList__WEBPACK_IMPORTED_MODULE_3___default.a();
    app.forum.reactions().forEach(function (reaction) {
      return items.add(reaction.identifier().replace(/fa.? fa-/, ''), m("button", {
        className: "Button Button--link",
        type: "button",
        title: reaction.display() || reaction.identifier(),
        onclick: _this.react.bind(_this, reaction),
        "data-reaction": reaction.identifier()
      }, m("span", {
        className: "Button-label"
      }, m(_common_components_ReactionComponent__WEBPACK_IMPORTED_MODULE_8__["default"], {
  ...
  _proto.view = function view() {
    ...
    var postReactions = Object(_utils_groupBy__WEBPACK_IMPORTED_MODULE_7__["default"])(this.post.reactions().filter(Boolean) || [], function (r) {
      return r.reactionId();
    });
    var canReact = this.post.canReact();
    return m("div", {
      style: "margin-right: 7px",
      className: "Reactions"
    }, m("div", {
      className: "Reactions--reactions"
    }, Object.keys(postReactions).map(function (id) {
      var reaction = app.store.getById('reactions', id);
      var count = postReactions[id].length;
      if (count === 0) return;
      var spanClass = reaction.type() === 'icon' ? reaction.identifier() + " emoji button-emoji reaction-icon" : '';
      var icon = m(_common_components_ReactionComponent__WEBPACK_IMPORTED_MODULE_8__["default"], {
        reaction: reaction,
        className: spanClass,
        "data-reaction": reaction.identifier()
      });
      return flarum_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
        className: "Button Button--flat Button-emoji-parent " + (_this2.reaction && _this2.reaction.reactionId() == reaction.id() && 'active'),
        onclick: canReact ? _this2.react.bind(_this2, _this2.reaction) : '',
        'data-reaction': reaction.identifier(),
        disabled: !canReact,
        children: m("span", null, icon, " ", count > 1 ? m("span", {
          className: "count"
        }, count) : '')
      });
    })), m("div", {
      className: "Reactions--react"
    }, this.reactButton(), !this.reaction && canReact ? m("div", {
      className: "CommentPost--Reactions",
      style: this.post.number() === 1 ? '' : 'left: -28%;'
    }, m("ul", {
      className: "Reactions--Ul"
    }, flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_5___default()(this.getReactions().toArray()))) : null));
  };

  _proto.reactButton = function reactButton() {
    ...
    return m("button", {
      ...
      height: "20px",
      viewBox: "0 0 18 18"
    }, "/* Generator: Sketch 40.3 (33839) - http://www.bohemiancoding.com/sketch */", m("g", {
      id: "Page-1",
      stroke: "none",
      "stroke-width": "1",
      fill: "none",
  ...
  _proto.react = function react(reaction, e) {
    var _this3 = this;
    ...
    if (!this.post.canReact()) {
      return app.alerts.show(this.successAlert = new flarum_components_Alert__WEBPACK_IMPORTED_MODULE_1___default.a({
        type: 'error',
    ...
    this.post.save({
      ...
      if (app.forum.data.relationships.ranks !== undefined && (app.forum.attribute('ReactionConverts')[0] === reaction || app.forum.attribute('ReactionConverts')[1] === reaction) || _this3.post.data.relationships.likes !== undefined && app.forum.attribute('ReactionConverts')[2] === reaction) {
        app.alerts.show(_this3.successAlert = new flarum_components_Alert__WEBPACK_IMPORTED_MODULE_1___default.a({
          type: 'warning',
  ...
  _proto.updateChosenReaction = function updateChosenReaction() {
    var postReactions = this.post.reactions() || [];
    return this.reaction = app.session.user && postReactions.filter(function (reaction) {
      return reaction.userId() == app.session.user.id();
    })[0];
  };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PostReactedNotification; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose.js */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
var PostReactedNotification =
/*#__PURE__*/
function (_Notification) {
  Object(_babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__["default"])(PostReactedNotification, _Notification);

  function PostReactedNotification() {
    return _Notification.apply(this, arguments) || this;
  }

  var _proto = PostReactedNotification.prototype;
  ...
  _proto.content = function content() {
    ...
    var _JSON$parse = JSON.parse(notification.content()),
        identifier = _JSON$parse.identifier,
        type = _JSON$parse.type;

    var user = notification.fromUser();
    var reaction = type === 'emoji' ? m("img", {
      src: Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_3__["default"])(identifier).url,
      loading: "lazy",
      height: "14px"
    }) : flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_2___default()(identifier);
...
/***/ "./src/forum/components/ReactionsModal.js":
/*!************************************************!*\
  !*** ./src/forum/components/ReactionsModal.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ReactionsModal; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose.js */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
/* harmony import */ var _utils_groupBy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/groupBy */ "./src/forum/utils/groupBy.js");
...
/*#__PURE__*/
function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__["default"])(ReactionsModal, _Modal);

  function ReactionsModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = ReactionsModal.prototype;
  ...
  _proto.init = function init() {
    this.loading = true;
    this.groupedReactions = Object(_utils_groupBy__WEBPACK_IMPORTED_MODULE_6__["default"])(this.props.post.reactions().filter(Boolean), function (r) {
      return r.reactionId();
    });
    this.load();
  };
  ...
  _proto.content = function content() {
    ...
    }, Object.keys(this.groupedReactions).map(function (id) {
      var reaction = app.store.getById('reactions', id);
      var postReactions = _this.groupedReactions[id];
      if (!postReactions.length) return;
      return m("div", {
        className: "ReactionsModal-group"
      }, m("legend", null, m(_common_components_ReactionComponent__WEBPACK_IMPORTED_MODULE_5__["default"], {
        reaction: reaction,
        className: 'ReactionModal-reaction'
      }), m("label", {
        className: "ReactionsModal-display"
      }, reaction.display() || reaction.identifier())), m("hr", {
        className: "ReactionsModal-delimiter"
      }), postReactions.filter(function (r) {
        return r.user();
      }).map(function (r) {
        return m("li", null, m("a", {
          className: "ReactionsModal-user",
          href: app.route.user(r.user()),
          config: m.route
        }, flarum_helpers_avatar__WEBPACK_IMPORTED_MODULE_3___default()(r.user(), {
          loading: 'lazy'
        }), " ", flarum_helpers_username__WEBPACK_IMPORTED_MODULE_4___default()(r.user())));
      }));
    })));
  };
  ...
  _proto.load = function load() {
    return app.request({
      ...
      return app.store.pushPayload(response);
...
/* harmony import */ var flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! flarum/components/NotificationGrid */ "flarum/components/NotificationGrid");
/* harmony import */ var flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_PostReactedNotification__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/PostReactedNotification */ "./src/forum/components/PostReactedNotification.js");
/* harmony import */ var _common_models_Reaction__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/models/Reaction */ "./src/common/models/Reaction.js");
/* harmony import */ var _models_PostReaction__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./models/PostReaction */ "./src/forum/models/PostReaction.js");
/* harmony import */ var _addPusher__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./addPusher */ "./src/forum/addPusher.js");
/* harmony import */ var _addReactionAction__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./addReactionAction */ "./src/forum/addReactionAction.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('fof/reactions', function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.models.reactions = _common_models_Reaction__WEBPACK_IMPORTED_MODULE_8__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.models.post_reactions = _models_PostReaction__WEBPACK_IMPORTED_MODULE_9__["default"];
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.notificationComponents.postReacted = _components_PostReactedNotification__WEBPACK_IMPORTED_MODULE_7__["default"];
  flarum_models_Post__WEBPACK_IMPORTED_MODULE_4___default.a.prototype.canReact = flarum_Model__WEBPACK_IMPORTED_MODULE_5___default.a.attribute('canReact');
  flarum_models_Post__WEBPACK_IMPORTED_MODULE_4___default.a.prototype.reactions = flarum_Model__WEBPACK_IMPORTED_MODULE_5___default.a.hasMany('reactions');
  flarum_models_Forum__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.reactions = flarum_Model__WEBPACK_IMPORTED_MODULE_5___default.a.hasMany('reactions');
  flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.canSeeReactions = flarum_Model__WEBPACK_IMPORTED_MODULE_5___default.a.attribute('canSeeReactions');
  Object(_addReactionAction__WEBPACK_IMPORTED_MODULE_11__["default"])();
  Object(_addPusher__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_NotificationGrid__WEBPACK_IMPORTED_MODULE_6___default.a.prototype, 'notificationTypes', function (items) {
    items.add('postReacted', {
      name: 'postReacted',
      icon: 'fas fa-eye',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-reactions.forum.settings.notify_post_reacted_label')
    });
  });
});
...
/***/ "./src/forum/models/PostReaction.js":
/*!******************************************!*\
  !*** ./src/forum/models/PostReaction.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PostReaction; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose.js */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_Model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/Model */ "flarum/Model");
/* harmony import */ var flarum_Model__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_Model__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_utils_mixin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/utils/mixin */ "flarum/utils/mixin");
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose_js__WEBPACK_IMPORTED_MODULE_0__["default"])(PostReaction, _mixin);
  ...
  reaction: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasOne('reaction'),
  userId: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('userId'),
  postId: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('postId'),
  reactionId: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('reactionId'),
