...
var PostReactAction = /*#__PURE__*/function (_Component) {
  ...
  _proto.init = function init() {
    ...
    this.reaction = app.session.user && reactions.filter(function (r) {
...
var ReactionsModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.init = function init() {
    this.idToReaction = app.forum.reactions().filter(function (x) {
      return x['data']['attributes']['display'];
    }).reduce(function (a, x) {
      var _extends2;

      return Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, a), {}, (_extends2 = {}, _extends2[Number(x['data']['id'])] = x['data']['attributes']['display'], _extends2));
    }, {});
    ...
    this.groupedReactions.forEach(function (g) {
      g.forEach(function (r) {
        app.store.find('users', r['userId']).then(function (user) {
          r['modalUser'].push(m("li", null, m("a", {
            className: "ModalUser",
  ...
  _proto.content = function content() {
    return m("div", {
      ...
      }, m("legend", null, g[0]['legend']), m("hr", null), g.map(function (r) {
        return r['modalUser'];
      }));
    })));
  };
  ...
  _proto.groupReactions = function groupReactions(reactions) {
    ...
    var informativeReactions = reactions.map(function (x) {
      var toReturn = {};
      toReturn['id'] = Number(x['data']['id'].split('-')[0]);
      var tType = x['data']['attributes']['type'];
      var tIdentifier = x['data']['attributes']['identifier'];
      var appendage = _this.idToReaction[toReturn['id']] || "";

      if (tType === "emoji") {
        toReturn['legend'] = [m("img", {
          className: "reaction-emoji",
          src: Object(_common_util_emoji__WEBPACK_IMPORTED_MODULE_5__["default"])(tIdentifier).url
        }), m("label", null, appendage)];
      } else if (tType === "icon") {
        toReturn['legend'] = m("i", {
          className: "fa fa-" + tIdentifier + " reaction-icon",
          "data-reaction": tIdentifier
        });
      } else {
