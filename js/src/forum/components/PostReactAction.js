...
export default class PostReactAction extends Component {
  ...
  view() {
    ...
    if (hasReacted) {
      return <div className="Reactions">{this.unreactButton()}</div>;
    }
  ...
  unreactButton() {
    return (
      <Button
        className="Button Button--link Reactions--ShowReactions"
        type="Button"
        title={app.translator.trans('fof-reactions.forum.unreact_button_label')}
        aria-label={app.translator.trans('fof-reactions.forum.unreact_button_label')}
        loading={this.loading[null]}
        onclick={() => reactToPost(this.post, null, this.loading)}
      >
        <span className="Button-label">
          <svg class="button-react" width="20px" height="20px" viewBox="0 0 18 18">
            <g id="Unreaction" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g id="ic_unreactions_grey">
                <g id="Group-2">
                  <g id="0:0:0:0">
                    <rect id="Rectangle-5" x="0" y="0" width="18" height="18" />
                    <g id="emoticon" />
                  ...
                  <g id="Group-15" transform="translate(10.666667, 0.000000)" fill="#667c99">
                    <rect id="Path" x="0" y="1" width="5.33333333" height="1.33333333" />
                  </g>
                </g>
              </g>
            </g>
  ...
  react(reaction, e) {
    e.target.blur();
    return reactToPost(this.post, reaction, this.loading);
  }
